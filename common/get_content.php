...
include_once "/var/www/html/my_API/common/mysqli.php";
include_once "/var/www/html/my_API/common/curl.php";
...
class Get_proxy {
    ...
    //not just heml rather than could to analy by html-parser
